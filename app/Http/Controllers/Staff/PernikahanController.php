    ...
    public function storePernikahan(Request $r){
        ...
        if (!$validator->fails()) {
            ...
            if ($r->file('foto')->isValid()) {
                Image::make($gambar)->resize(300, 400)->save(public_path('/images/pernikahan/'.$filename));
                $file = Pernikahan::create([
                ...
                Session::flash('success', 'Pernikahan berhasil ditambahkan!');
    ...
    public function updatePernikahan(Request $r, $id){
        ...
        if($r->file('foto')){
            ...
            Image::make($gambar)->resize(300, 400)->save(public_path('/images/pernikahan/'.$filename));
             ...
             Session::flash('success', 'Data pernikahan baru berhasil ditambahkan!');
             return redirect(Help::url('pernikahan'));
            }
        }else{
             $pernikahan = Pernikahan::findOrFail($id)->update([
